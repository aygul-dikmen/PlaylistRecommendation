            ...
            <Grid container spacing={3} xs={10} direction="row">
              ...
              <Grid item xs={6} style={{ paddingLeft: "100px" }}>
                ...
                <Typography align="center">
                  ...
                  University. Recently I've been interested in Machine Learning
                  and Data Science.
                </Typography>
                <hr />
                <IconButton
                  onClick={() =>
                    window.open("https://github.com/aygul-dikmen", "_blank")
                  }
                >
                  <GitHub fontSize="large" />
                </IconButton>
                <a href="mailto:ayguldikmen@gmail.com" target="_top">
                  <IconButton>
                ...
                <IconButton
                  onClick={() =>
                    window.open(
                      "https://www.linkedin.com/in/aygul-dikmen-b5b42b172/",
                      "_blank"
                    )
                  }
                >
          ...
          <Card style={styles.gridItem}>
            <Grid container spacing={3} xs={10} direction="row">
              ...
              <Grid item xs={6} style={{ paddingLeft: "100px" }}>
                ...
                <a href="mailto:busraoran043@gmail.com" target="_top">
                  <IconButton>
                    <Email fontSize="large" />
                  </IconButton>
                </a>
                ...
                <IconButton
                  onClick={() =>
                    window.open(
                      "https://www.linkedin.com/in/busraoran/",
                      "_blank"
                    )
                  }
                >
